...
const columns = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      return (
        <div className="text-left px-5">{row.getValue("productName")}</div>
      );
    },
  },
  {
    ...
    header: () => {
      return <div className="text-left">Product Type</div>;
    },
    cell: ({ row }) => {
      return <div className="text-left">{row.getValue("productType")}</div>;
    },
  },
  {
    accessorKey: "depositType",
    header: () => {
      return <div className="text-left">Deposit Type</div>;
    },
    cell: ({ row }) => {
      return <div className="text-left">{row.getValue("depositType")}</div>;
    },
  },
  {
    id: "actions",
...
const DepositProductTable = ({ data }) => {
