...
const columns = [
  ...
  },
  {
    ...
    header: () => {
      return <div className="text-left">Account Ledger Name</div>;
    },
    cell: ({ row }) => {
      return <div className="text-left">{row.getValue("ledgerName")}</div>;
    },
  },
  {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center sm:items-end pt-4">
      <div className="flex justify-end items-center py-4">
        <Input
          placeholder="Filter ledger name..."
          value={table.getColumn("ledgerName")?.getFilterValue() ?? ""}
          onChange={(event) =>
